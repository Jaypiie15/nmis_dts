	...
	<div class="page-content login-cover">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<!-- Login form -->
				<form class="login-form wmin-sm-400 form-validate" action="{{ route('search-document') }}" method="POST">
					@csrf
					<div class="card mb-0">
						...
						<div class="tab-content card-body">
							<div class="tab-pane fade show active" id="login-tab1">
								<div class="text-center mb-3">
									...
									<span class="d-block text-muted">Input Tracking Number</span>
								</div>

								<div class="form-group form-group-feedback form-group-feedback-left">
									<input type="text" class="form-control" name="tracking_number" placeholder="Enter Tracking Number" autocomplete="off">
									<div class="form-control-feedback">
										<i class="icon-file-pdf text-muted"></i>
									</div>
								</div>
								...
								<div class="form-check mb-0">
									<a href="{{ route('login') }}" class="ml-auto">Login to your account?</a>
							
									</div>
								</div>
								
								<div class="form-group">
									<button type="submit" class="btn btn-primary btn-block"> <i class="icon-search4"></i> Track Document  </button>
								</div>
