	...
	<div class="page-content login-cover">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<!-- Login form -->
				<form class="login-form wmin-sm-400 form-validate" action="{{ route('update-info') }}" method="POST">
					@csrf
					<div class="card mb-0">
						...
						<div class="tab-content card-body">
							<div class="tab-pane fade show active" id="login-tab1">
								<div class="text-center mb-3">
									...
									<span class="d-block text-muted">Input Information</span>
								</div>

								<div class="form-group form-group-feedback form-group-feedback-left">
									<input type="text" class="form-control" name="division_email" placeholder="Enter Govmail Email" autocomplete="off" required>
                                ...
                                <div class="form-group form-group-feedback form-group-feedback-left">
									<input type="password" class="form-control" name="password" placeholder="Update Password" autocomplete="off" required>
									<div class="form-control-feedback">
								...
								<div class="form-group">
									<button type="submit" class="btn btn-primary btn-block"> <i class="icon-exit"></i> Update Information </button>
								</div>
