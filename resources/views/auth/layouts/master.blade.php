...
<head>
	...
	<title>NMIS HRM Time and Attendance System</title>
			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item"><a href="{{ route('dashboard')}}" class="nav-link"><i class="icon-home4"></i> <span>Dashboard</span></a></li>

						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-alarm-check"></i> <span>Time attendance Record</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="{{ route('view-timein')}}" class="nav-link">Attendance Records</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Themes">
								<li class="nav-item"><a href="{{ route('view-employees')}}" class="nav-link">View Employees</a></li>
								<li class="nav-item"><a href="{{ route('add-employee')}}" class="nav-link">Add Employee</a></li>
							</ul>
						</li>
						
						<li class="nav-item"><a href="{{ route('generate-report') }}" class="nav-link"><i class="icon-file-pdf"></i> <span>Generate DTR</span></a></li>
